 ...
 <form action="<?=base_url('/master/index/tbl_cert_birth');?>" method="post" id="serch_data">
 ...
 <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  ...
                  <p class="card-category">Birth Certificates</p>
                </div>
                <div class="card-body">
                    ...
                    <?php if($listings) :?>
                      ...
                      <?php $count = 1; foreach($listings as $listing): //print_r($listing); exit;?>
                        ...
                        <tr id="row_<?=$listing->ID;?>">
                          ...
                          <td>
                          <?=date('d/m/Y', strtotime($listing->birthdate));?> / <?=$listing->birthtime?>
                          </td>
                          <td>
                          <?=$listing->dname;?>
                          </td>
  ...
  <script type="text/javascript">
    $('.add_item').click(function(){
       $("#load_view").load("<?=base_url('/master/update/tbl_cert_birth');?>"); 
    });
    $('.edit_item').click(function(){ 
       $("#load_view").load("<?=base_url('/master/update/tbl_cert_birth/');?>" + $(this).attr('id')); 
    });
   $('.delete_item').click(function(){ 
      if(confirm("Are you sure?")){
       $.get("<?=base_url('/master/delete/tbl_cert_birth/');?>" + $(this).attr('id'), function(data){
