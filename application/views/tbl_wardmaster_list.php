 ...
 <div class="col-md-12">
              <div class="card">
                ...
                <div class="card-header card-header-primary">
                  ...
                  <p class="card-category"> Ward Master</p>
                </div>
                <div class="card-body">
  ...
  <script type="text/javascript">
    $('.add_item').click(function(){
       $("#load_view").load("<?=base_url('/master/update/tbl_wardmaster');?>"); 
    });
    $('.edit_item').click(function(){ 
       $("#load_view").load("<?=base_url('/master/update/tbl_wardmaster/');?>" + $(this).attr('id')); 
    });
   $('.delete_item').click(function(){ 
      if(confirm("Are you sure?")){
       $.get("<?=base_url('/master/delete/tbl_wardmaster/');?>" + $(this).attr('id'), function(data){
