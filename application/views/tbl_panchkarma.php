<div class="col-md-12 fetch_results">
              <div class="card">
                <div class="col-md-12">
                  ...
                  <h4 class="card-title ">Panchkarma</h4>
                  <p class="card-category"> Panchkarma Register Master</p>
                </div>
                <br>
                <form action="<?=base_url('/master/update');?>" method="post" id="save_data">
                  ...
                  <input type="hidden" name="tbl" value="<?=$tbl;?>">
                    <div class="row">
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          <label class="bmd-label-floating">DOA</label>
                          <input type="text" class="form-control" name="doa" id="doa" data-toggle="datepicker"  value="<?=($data->doa) ? date('d/m/Y', strtotime($data->doa)) : date('d/m/Y');?>">
                        </div>
                      </div>
                      <div class="col-md-4">
                        <div class="form-group">
                          <label class="bmd-label-floating">DOP</label>
                          <input type="text" class="form-control" name="pdate" data-toggle="datepicker" id="pdate" value="<?=($data->pdate) ? date('d/m/Y', strtotime($data->pdate)) : date('d/m/Y');?>" required="required">
                        </div>
                      </div>
                      <div class="col-md-2">
                        <div class="form-group">
                      ...
                      <div class="col-md-2">
                        <div class="form-group">
                          ...
                          <?=get_year_code();?>
                          <input type="text" class="form-control" id="ipdno" value="<?=($data->ipdno);?>">
                        </div>
                      </div>
                    </div>
                    <div class="row">
                    ...
                    <?php  foreach($karamas as $key => $item): ?>
                    <div class="col-md-3">
                    <?=$item;?>
                    </div>
                    <div class="col-md-9">
                    <input type="text" class="form-control" name="name[<?=$key;?>]" value="<?php foreach($savekaramas as $pkey => $pitem): if($pkey == $key){ echo $pitem;} endforeach;?>" >
                    </div>
                    <?php endforeach; ?>
                    </div>                  
