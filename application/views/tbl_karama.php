                  ...
                  <input type="hidden" name="tbl" value="<?=$tbl;?>">
                    <div class="row">
                      ...
                      <div class="form-group">
                          <label class="bmd-label-floating">Karama Parent</label>
                          <?php echo form_dropdown('parent_id', $karama_parents, $data->parent_id, 'class="form-control"'); ?>    
                        </div>
                        <div class="form-group">
                          <label class="bmd-label-floating">Karama Name</label>
