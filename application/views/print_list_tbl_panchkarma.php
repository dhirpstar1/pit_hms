...
<hr>
                        ...
                        <td><?=$listing->pname;?></td>
                        <td><?=$listing->sex;?></td>
                        <td style="padding:10px;"><?=$listing->karamas_data;?></td>
                         </tr>
                         <?php if(($count % 16) == 0){?> 
...
<?php } ?>  
                 ...
                 <tr class="text-primary">
                 <?php foreach($karamas as $item): ?>
                    <th><?=$item;?></th>
                      <?php endforeach; ?>
                  </tr><hr>
                  <tr>       
                  <?php $total =0; foreach($karamas as $key => $item): ?><td> <?php
                  $pcount = 0;
                  foreach($karamas_count as $item1):
                                    
                      if($item1->karama_id == $key):  $pcount = $item1->karama_count; endif; 
