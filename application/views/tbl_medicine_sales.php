...
<form action="<?=base_url('/master/update_with_id');?>" method="post" id="save_data">
   ...
   <script type="text/javascript">
    ...
    $('.edit_item').click(function(){  alert();
       $("#load_view").load("<?=base_url('/master/update/tbl_medicine_sales/');?>" + $(this).attr('id')); 
    });
   $('.delete_item').click(function(){ 
      if(confirm("Are you sure?")){
       $.get("<?=base_url('/master/delete/tbl_medicine_sales/');?>" + $(this).attr('id'), function(data){
