        ...
        <div class="container-fluid">
          <div class="row">
            ...
            <div id="load_view" class="col-md-12">
               <form action="<?=base_url('/master/report/tbl_opd_patient');?>" method="post" id="serch_data">
...
var url = "<?=base_url('/master/print_report/tbl_opd_patient');?>";
 ...
 <div class="col-md-12">
              <div class="card">
                ...
                <div class="card-header card-header-primary">
                  <h4 class="card-title ">OPD Report</h4>
                  <p class="card-category"> Central Regitration OPD Patient Sheet</p>
                </div>
                <div class="card-body">
